#include < iostream > #include < stdio.h > #include < pthread.h >
  //#include <random>
  #include < stdlib.h > #include < time.h > #include < fstream > #include < string > #include < mutex > #include < thread > #include < cstdlib >

  int ** myM, M, * M2, counter, N, error;
bool valid = false;
int x, y;
